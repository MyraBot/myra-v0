...
public class Utilities {
    //colours
    public int red = 0xFF0055;
    public int blue = 0xccd9f0;
    ...
    public Utilities() {
        ...
        HypixelKey = "6cb5b7e7-66ab-477d-9d18-4f029e676d37";
        //emojis
        offline = "<:Offline:749616594916868098>";
        idle = "<:Idle:749616593973018665>";
        doNotDisturb = "<:DoNotDisturb:749616593939726346>";
        ...
        bravery = "<:Bravery:751102172158099600>";
        brilliance = "<:Brilliance:751102172640444477>";
        balance = "<:balance:751102171092615219>";

        partner = "<:Partner:748984597584412883>";
        verifiedDeveloper = "<:VerifiedDeveloper:726467094413181019>";
        staff = "<:staff:751105613831995454>";
    }
    ...
    public Color getMemberRoleColour(Member member) {
        ...
        if (roles.isEmpty()) {
            return new Color(Manager.getUtilities().gray);
        }
        Color colour = roles.get(0).getColor();
        for (Role role : roles) {
            if (role.getColorRaw() != 536870911) { //RGB int value of default color
                colour = role.getColor();
                break;
            }
        }
        return colour;
    ...
    public User getModifiedUser(GuildMessageReceivedEvent event, String userRaw, String command, String commandEmoji) {
        User user = null;
        //get jda
        JDA jda = event.getJDA();
        // If user is given by mention
